...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "ROBqDDBq0erjfMm3CGcA0FHs2M4ujj6srA4BsvA4";
    private static final String SECRETKEY = "DrX-FLxnGuERd4CJn0SEFmVnljoL6eu6B_n15zub";
    private static final String BUCKET = "myhealth-cangku";
    public static final String DOMAIN= "http://qipa5s0rw.hn-bkt.clouddn.com/";
